...
def empty_queue(queue_name, registry_name):
    if registry_name == "queued":
        ...
        FailedJobRegistry(queue_name).get_queue().empty()
    elif registry_name == "deferred":
        DeferredJobRegistry(queue_name).get_queue().empty()
    elif registry_name == "started":
        StartedJobRegistry(queue_name).get_queue().empty()
    elif registry_name == "finished":
        FinishedJobRegistry(queue_name).get_queue().empty()
    return dict(status="OK")
